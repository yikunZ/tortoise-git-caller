...
internal class RebaseAction : AnAction("Rebase") {
    init {
        ...
        // 考虑把这两边的代码融合在一起
        val shortcut = KeyboardShortcut(KeyStroke.getKeyStroke("control G"), KeyStroke.getKeyStroke("R"))
