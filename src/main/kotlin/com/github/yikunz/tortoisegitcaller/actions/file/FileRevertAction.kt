package com.github.yikunz.tortoisegitcaller.actions.file

import com.github.yikunz.tortoisegitcaller.util.Command
import com.intellij.openapi.actionSystem.*
import javax.swing.KeyStroke

internal class FileRevertAction : AnAction("File revert") {
    init {
        ...
        // 考虑把这两边的代码融合在一起
        val shortcut = KeyboardShortcut(KeyStroke.getKeyStroke("control shift G"), KeyStroke.getKeyStroke("V"))
