...
internal class MergeAction : AnAction("Merge") {
    init {
        ...
        // 考虑把这两边的代码融合在一起
        val shortcut = KeyboardShortcut(KeyStroke.getKeyStroke("control G"), KeyStroke.getKeyStroke("M"))
